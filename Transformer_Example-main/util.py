...
def attention(Q, K, V, mask):
    # b句话,每句话50个词,每个词编码成32维向量,4个头,每个头分到8维向量 32/4=8
    #几句话也就是batch_size是几？
    # Q,K,V = [b, 4, 50, 8]
...
class MultiHead(torch.nn.Module):
    def __init__(self):
        ...
        '''一般来说，对于图像经常做层归一化 对于自然语言处理中的文本序列 经常做层归一化'''
        '''层归一化可以降低每次传入序列长度不同的影响'''
...
class PositionEmbedding(torch.nn.Module):
    def __init__(self):
        ...
        '''使用pytorch中register_buffer函数 来将变量固定为不可更新的常量'''
        # 词编码层
