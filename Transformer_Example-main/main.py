...
model = Transformer()
# model.load_state_dict(torch.load(r'D:\pytorch code\Transformer_Example-main\Transformer_Example-main\2model_9000_0.935251798561151.pt'))
    ...
    for epoch in range(10):
        for i, (x, y) in enumerate(loader):
            ...
            if i % 200 == 0:
                ...
                if i % 600 == 0:
                    torch.save(model.state_dict(), "model_{}_{}.pt".format(i,accuracy))
...
# train()
# model = model.load_state_dict(torch.load(r'D:\pytorch code\Transformer_Example-main\Transformer_Example-main\1model_11400_0.990990990990991.pt'))
